# Bautista Ribotta - Portafolio Web
...
* **Glassmorphism:** Uso extensivo de efectos de vidrio esmerilado (`backdrop-filter: blur`) para tarjetas y contenedores.
* **Temas Dinámicos:** Selector de modo **Claro / Oscuro** con persistencia de preferencias y variables CSS nativas.
...
* **CSS3:**
    ...
    * Flexbox y Grid para maquetación avanzada.
    * Animaciones `keyframes` y transiciones suaves.
* **JavaScript (ES6):**
    * Lógica para el cambio de tema en tiempo real.
    * Manejo de formularios (`fetch API`).
* **Herramientas Externas:**
    * [Formspree](https://formspree.io/): Backend como servicio para el formulario de contacto.
...
1.  **Clonar el repositorio:**
    ```bash
    git clone [https://github.com/bautistaribotta/bautistaribotta.github.io.git](https://github.com/bautistaribotta/bautistaribotta.github.io.git)
    cd bautistaribotta.github.io
    ```
...
---
*Diseñado y desarrollado por [Bautista Ribotta](https://www.linkedin.com/in/bautistaribotta/) - 2026.*